...
const Footer = () => {
  return (
    ...
    items-center dark:bg-slate-900 bg-white flex-col">
      ...
      <div className="flex h-[100%] pt-5 pr-5 pl-5 sm:h-[30%] w-[100%]  bg-gray-300 dark:bg-slate-200 items-center justify-between">
        <div className="flex h-[100%] w-[20%] flex-col  ">
