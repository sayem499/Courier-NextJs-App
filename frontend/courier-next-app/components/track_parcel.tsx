                ...
                <div className='flex w-[100%] h-[15%] justify-center items-center mt-20'>
                    ...
                    {parcelStatus && <ul className=' w-[100%] h-[100%] flex justify-center m-auto text-sm' id='progress-ul'>
                        {steps.map((item, index) => (
                                ...
                                `}>
                                       {  parcelStatus && parcelStatus.stepAction > index ?  <DoneIcon className='text-sm rounded-full bg-green-500'/> : <span className={`rounded-full ${parcelStatus && parcelStatus.stepAction >= index ? 'bg-green-500' : 'bg-gray-500'}  w-3 h-3 `}></span>
