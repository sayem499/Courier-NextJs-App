...
const Imageslider: React.FC<{ slides: SlideArray }> = ({slides}) => {
  ...
  return (
    <div className="sm:w-full sm:h-[78%] items-center group">

      <img src={slides[index].url} alt=''
      className="object-fill w-full sm:h-[100%] duration-500"></img>

      <div className='hidden group-hover:flex absolute top-[50%] 
      translate-x-0 translate-y-[-1/2] left-3 cursor-pointer
